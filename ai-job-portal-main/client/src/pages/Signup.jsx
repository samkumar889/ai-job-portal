    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <label className="block mb-3 font-semibold text-lg">Role</label>
            <select
              name="role"
              value={formData.role}
              onChange={handleChange}
        ...
        >
          <p className="text-lg">
            ...
            <Link to="/login" className="font-extrabold text-xl underline underline-offset-4 hover:opacity-80 transition-opacity">
              Sign In
            </Link>
          </p>
        </motion.div>
